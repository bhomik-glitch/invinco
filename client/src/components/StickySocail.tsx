    ...
    <div className="fixed left-0 top-1/2 -translate-y-1/2 z-50">
      <div className="flex flex-col space-y-4 p-2 bg-[#2c4d42] backdrop-blur-sm rounded-r-lg">
        ...
        <a 
          ...
          className="text-white hover:text-gray-300 transition-colors"
        >
          <svg className="w-6 h-6 md:w-8 md:h-8" viewBox="0 0 2500 2500" xmlns="http://www.w3.org/2000/svg">
            <defs>
          ...
          <span className="sr-only">Lt Col Ankur Sabharwal Instagram profile</span>
        </a>
        <a 
